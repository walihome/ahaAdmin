...
const tabs = [
  { section: '内容管理', items: [
    ...
    { key: 'content', label: '内容正文', icon: 'file-text' },
    ...
    <div v-for="section in tabs" :key="section.section" class="nav-section">
      ...
      >
        <div class="nav-icon">
          ...
          <!-- file-text -->
          <svg v-else-if="item.icon === 'file-text'" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
          <!-- check -->
